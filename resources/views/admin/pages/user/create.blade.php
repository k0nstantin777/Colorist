...
@component('admin.components.page-header')
    @slot('head')Создание пользователя@endslot
    @slot('breadcrump')
        ...
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Форма создания профиля</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="{{route('admin.user.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="form-group {{ $errors->has('login') ? ' has-error' : '' }}">
                            <label for="login">Login <span class="text-red" title="Заполнение поля обязательно">*</span></label>
                             <div class="input-group">
                                <div class="input-group-addon">
                                    <i class="fa fa-user"></i>
                                </div>
                            <input type="text" class="form-control" id="login" name="login" value="{{old('login')}}" autofocus placeholder="Введите логин">
                            </div>
                            @if ($errors->has('login'))
                        ...
                        <div class="form-group">
                            <label>Тип аккаунта <span class="text-red" title="Заполнение поля обязательно">*</span></label>
                        ...
                        <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="email">Email <span class="text-red" title="Заполнение поля обязательно">*</span></label>
                            <div class="input-group">
                                <div class="input-group-addon">
                        ...
                        <div class="form-group {{ $errors->has('phone') ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" id="phone" name="phone" value="{{old('phone')}}" data-inputmask='"mask": "+9 (999) 999-9999"' data-mask>
                            </div>
                            @if ($errors->has('phone'))
                                <span class="help-block">
                        ...
                        <div class="form-group {{ $errors->has('password') ? ' has-error' : '' }}">
                            <label for="password">Пароль <span class="text-red" title="Заполнение поля обязательно">*</span></label>
                             <div class="input-group">
                                <div class="input-group-addon">
                        ...
                        <div class="form-group {{ $errors->has('repeate_password') ? ' has-error' : '' }}">
                            <label for="repeate_password">Повторите пароль <span class="text-red" title="Заполнение поля обязательно">*</span></label>
                             <div class="input-group">
                                <div class="input-group-addon">
                                    <i class="fa fa-eye-slash"></i>
                                </div>
                                 <input type="password" class="form-control" id="repeate_password" name="repeate_password" placeholder="Повторите пароль">
                            </div>    
                        ...
                        <div class="form-group {{ $errors->has('first_name') ? ' has-error' : '' }}">
                            <label for="first_name">Имя <span class="text-red" title="Заполнение поля обязательно">*</span></label>
                            <input type="text" class="form-control" id="first_name" name="first_name" value="{{old('first_name')}}" placeholder="Введите имя">
                        ...
                        <div class="form-group {{ $errors->has('last_name') ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" id="last_name" name="last_name" value="{{old('last_name')}}" placeholder="Введите фамилию">
                        ...
                        <div class="form-group {{ $errors->has('age') ? ' has-error' : '' }}">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="age" name="age" value="{{old('age')}}" placeholder="Введите возраст">
                            </div>    
                                @if ($errors->has('age'))
                                    <span class="help-block">
                        ...
                        <div class="form-group {{ $errors->has('birthdate') ? ' has-error' : '' }}">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask id="birthdate" name="birthdate" value="{{old('birthdate')}}">
                            </div>    
                        ...
                        <div class="form-group {{ session('errorUpload') ? ' has-error' : '' }} {{$errors->has('file') ? ' has-error' : '' }}">
                            ...
                            <div class="margin-bottom" style="overflow: hidden;">                          
                                ...
                                <img id="preview" src="" width="200" height="200" hidden/>
