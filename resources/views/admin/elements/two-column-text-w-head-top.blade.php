        ...
        <div class="box-body">
            ...
            <div class="box box-solid">
                ...
                <div class="box-body">
                    ...
                    @else
                            {{Form::open(['route' => ['admin.element.content.update', $element->id], 'class' => 'form-horizontal', 'role'=> 'form', 'id' => 'element'.$element->id])}}
                    @endif
                            {{Form::adminTextareaCK('texts_'.(isset($element->content['texts'][0]->id) ? $element->content['texts'][0]->id : '0'), 'Текст 1', isset($element->content['texts'][0]->text) ? $element->content['texts'][0]->text : '')}}
                            {{Form::adminTextareaCK('texts_'.(isset($element->content['texts'][1]->id) ? $element->content['texts'][1]->id : '1'), 'Текст 2', isset($element->content['texts'][1]->text) ? $element->content['texts'][1]->text : '')}}
