        ...
        <div class="box-body">
            ...
            <div class="box box-solid">
                ...
                <div class="box-body">
                    ...
                    @endif
                        <div class="col-sm-2">
                            {{Form::adminImage('images_'.(isset($element->content['images'][0]->id) ? $element->content['images'][0]->id : ''),'Загрузить изображение', isset($element->content['images'][0]->path) ? config('imagestorage.originalImagesPath').'small/'.$element->content['images'][0]->path : '' )}}
                        </div>
                        <div class="col-sm-10">
                ...
                <div class="box-footer clearfix">
                    {{Form::adminSubmit('Сохранить', ['type'=>'submit', 'class' => 'btn btn-primary col-sm-offset-2', 'form' => 'element'.$element->id])}}
                </div>
            </div>
